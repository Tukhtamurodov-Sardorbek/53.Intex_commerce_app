...
class ProductCard extends GetView<HomeController> {
  ...
  final int index;
  const ProductCard({Key? key, required this.superIndex, required this.index})
      : super(key: key);
...
class ProductCardUi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<HomeController>(builder: (controller) {
      return Column(
        children: [
          controller.getStatus(superIndex: superIndex, index: index, categoryId: categoryId).isNotEmpty
              ? Row(
          ...
          Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: controller.products[superIndex][categoryId]![index].statusId == 3
                    ? () {}
                    : () {
